...
def NetworkPartition(number_of_x_blocks=None,
    ...
    if latitude is None:
        ...
        print('Warning: Latitude is not defined. Default latitude is 30 degree!')
    ...
    if (number_of_x_blocks != None) and (number_of_y_blocks != None) \
            and (grid_width == None) and (grid_height == None):
        print('Warning: Default grid_width and grid_height are 0.006!')
...
"""PART 6  OUTPUT FILES"""
def outputCSV(output_folder = None):
